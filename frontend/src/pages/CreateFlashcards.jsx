...
const CreateFlashcards = () => {
  ...
  const pipelineSteps = [
    { title: 'Initializing NLP environment', desc: 'Warming up spaCy context...', icon: Cpu, color: 'text-indigo-500 bg-indigo-500/10' },
    { title: 'Syntactic parsing & Part-Of-Speech Tagging', desc: 'Analyzing sentence dependencies...', icon: Brain, color: 'text-purple-500 bg-purple-500/10' },
    { title: 'Named Entity Recognition (NER)', desc: 'Detecting persons, dates, locations...', icon: Globe, color: 'text-amber-500 bg-amber-500/10' },
    { title: cardType === 'mcq' ? 'Formulating distractors' : cardType === 'fillup' ? 'Masking grammar targets' : 'Synthesizing definitions', desc: 'Applying heuristic generation rules...', icon: Zap, color: 'text-rose-500 bg-rose-500/10' },
          ...
          {isLoading ? (
            ...
            <Card className="p-8 shadow-2xl bg-white dark:bg-slate-900 border-slate-200/80 dark:border-slate-800/85 relative overflow-hidden">
              ...
              <div className="text-center pb-8">
                ...
                <h3 className="text-xl font-extrabold text-slate-900 dark:text-white">Processing Study Guide</h3>
                <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 mt-1.5">Our local NLP parsing pipeline is working on your text.</p>
              </div>
